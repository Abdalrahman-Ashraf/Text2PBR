...
def main():
    ...
    generated_map_path = text_to_texture(args.prompt, pbr_texture_dir, args.texture_name, args.ext)
    texture_to_pbr(generated_map_path, pbr_texture_dir, args.texture_name)
