...
def train(
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for i, (input_map, target_map) in enumerate(dataloader):
            ...
            with torch.amp.autocast(device_type="cuda"):
                ...
                cumulative_loss = (wl_mse + wl_lab + wl_fft + wl_lch + wl_gan + wl_vgg)
            ...
            generator_losses['lab'].append(wl_lab.item())
    ...
    if enable_logs:
        ...
        with open(training_logs_path, mode='w', newline='') as file:
            ...
            writer.writerow(['Epoch', 'Iteration', 'Loss', 'L1', 'LAB', 'FFT'])
...
def main():
    ...
    pbr_normaldx_dir = r"D:\Program Files\Python\Texture PBR Model\data\textures\ambientcg\normaldx"
    pbr_normalgl_dir = r"D:\Program Files\Python\Text2PBR\TexturePBR\data\textures\ambientcg\normalgl"
    ...
    train(
        ...
        d_optimizer       = d_optimizer,
        run_name          = "displacement_v0.80_base",
        ckpt_name         = "",
        batch_size        = 18, 
        num_workers       = 2,
        num_epochs        = 10,
